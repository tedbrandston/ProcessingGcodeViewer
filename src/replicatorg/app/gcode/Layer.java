...
/**
 * 
 * @author Noah Levy This object is used to represent individual layers in Gcode, this is a revision
 *         of Will Langford's design
 */
public class Layer {
	...
	/**
	 * <code>height</code> holds the height of the given layer, instantiated to -1 for debugging
	 * purposes
	 */
